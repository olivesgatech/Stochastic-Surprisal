...
%  PI:                  Ghassan AlRegib
%  Version:             1.0
%  Published in:        Frontiers in Neuroscience, Vol 17, 2023
%  Publication details: 

%%
%Resize image to 0.5 times the original size - Faster processing
%and HVS is more adapted to low frequency components. Since there are 63580 images in DR IQA dataset,
%we first resized each image to 512x384 before resizing further by 0.5
%to additionally increase processing speed. 
